...
export default function GoogleDriveFiles({}: Props) {
  ...
  const onListener = async () => {
    ...
    if (listener?.googleResourceId !== null) return setIsListening(true);
  };
        ...
        >
          {loading ? (
            <div className="absolute flex h-full w-full items-center justify-center">
              <svg
                aria-hidden="true"
                className="inline h-8 w-8 animate-spin fill-[#6C47FF] text-gray-200 dark:text-gray-600"
                viewBox="0 0 100 101"
                fill="none"
